package cn.mmm.controller.admin;

import cn.mmm.constant.LogActions;
import cn.mmm.constant.WebConst;
import cn.mmm.controller.BaseController;
import cn.mmm.exception.BusinessException;
import cn.mmm.model.UserDomain;
import cn.mmm.service.log.LogService;
import cn.mmm.service.user.UserService;
import cn.mmm.utils.APIResponse;
import cn.mmm.utils.IPKit;
import cn.mmm.utils.TaleUtils;
...
public class AuthController extends BaseController{
    ...
    public APIResponse toLogin(
        ...
        try {
            ...
            if (error_count > 20) {
                return APIResponse.fail("您输入密码已经错误超过20次，请10分钟后尝试");
            }
            cache.hset("login_error_count", ip,error_count, 5 * 60); // 加入ip的过滤
            String msg = "登录失败";
